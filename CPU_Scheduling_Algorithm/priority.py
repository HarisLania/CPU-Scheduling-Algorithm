class Priority:
    ...
    def print_data(self):
        print('{:^20}{:^20}{:^20}{:^20}{:^20}{:^20}{:^20}'.format('Process', 'Arrival Time', 'Burst Time', 'Priority', 'Completion Time', 'Turnaround Time', 'Waiting Time'))
        for i in range(self.pcb_len):
            print('{:^20}{:^20}{:^20}{:^20}{:^20}{:^20}{:^20}'.format(self.pcb[i]['process_id'], self.pcb[i]['AT'], self.pcb[i]['BT'], self.pcb[i]['Prior'], self.pcb[i]['CT'], self.pcb[i]['TAT'], self.pcb[i]['WT']))    
